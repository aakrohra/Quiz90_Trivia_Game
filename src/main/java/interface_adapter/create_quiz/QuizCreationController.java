...
public class QuizCreationController {
     ...
     */
    public void executeCreateQuiz(List<PlayerCreatedQuestion> questions, String title) {
        final QuizCreationInputData inputData = new QuizCreationInputData(questions, title);
